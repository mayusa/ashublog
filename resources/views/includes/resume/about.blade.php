...
<section id="about" class="pt-page page-layout">
  ...
  <div class="content">
    ...
    <div class="layout-medium">
      ...
      <strong>Specialties</strong><br>Web application development<br> user interface design <br>product design <br>R&D ( Research and Development ) product management <br>Wechat(微信) development and Wechat Payment solutions for cross-border marketing.
      </p>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          ...
          <div class="service">
            ...
            <h4>R&D Management</h4>
            <p>Guarantee and improve product consistency and quality, deliver the right quality</p>
          </div>
          <!-- service -->
        ...
        <div class="col-sm-6 col-md-3">
          ...
          <div class="service">
            ...
            <p>Not only am I a problem solver – I also solve problems correctly with my years of experiences. </p>
          </div>
          <!-- service -->
