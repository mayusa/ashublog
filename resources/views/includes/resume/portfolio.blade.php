      ...
      <div class="portfolio-items media-grid masonry" data-layout="masonry" data-item-width="340">
        ...
        <div class="media-cell media image hentry">
          <div class="media-box">
            ...
            <div class="mask"></div>
            <!-- lightbox - image -->
            <a href="/resume/images/portfolio/lightbox-01.jpg" title="an illustration by Vasili Tkach"
               class="lightbox"></a>
            <!-- lightbox - image -->
          </div>
          <div class="media-cell-desc">
        ...
        <div class="media-cell illustration audio hentry">
          <div class="media-box">
            <img src="/resume/images/portfolio/05.jpg" alt="portfolio-post">
            <div class="mask"></div>
            <!-- lightbox - soundcloud : url copied from share/embed code -->
            <a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/221650664&amp;auto_play=true&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"
        ...
        <div class="media-cell media image hentry">
          <div class="media-box">
            <img src="/resume/images/portfolio/06.jpg" alt="portfolio-post">
            <div class="mask"></div>
            <!-- lightbox - gallery -->
            <a href="/resume/images/portfolio/lightbox-02.jpg" class="lightbox" title="This is title"></a>
            <a href="/resume/images/portfolio/lightbox-03.jpg" class="lightbox"></a>
            <a href="/resume/images/portfolio/lightbox-04.jpg" class="lightbox" title="Dog have dreams"></a>
            <!-- lightbox - gallery -->
          </div>
          <div class="media-cell-desc">
        ...
        <div class="media-cell media hentry">
          <div class="media-box">
            <img src="/resume/images/portfolio/08.jpg" alt="portfolio-post">
            <div class="mask"></div>
        ...
        <div class="media-cell media hentry">
          <div class="media-box">
            <img src="/resume/images/portfolio/09.jpg" alt="portfolio-post">
            <div class="mask"></div>
            <a href="portfolio-item-02.html" class="ajax"></a>
          </div>
          <div class="media-cell-desc">
