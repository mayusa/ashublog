...
console.log("uploadProfilePic", __WEBPACK_IMPORTED_MODULE_1__config__["b" /* uploadProfilePic */]);
  ...
  methods: {
    uploadFile: function uploadFile() {
      ...
      this.croppie.result({
        ...
        axios.post(__WEBPACK_IMPORTED_MODULE_1__config__["b" /* uploadProfilePic */], { file: _this.image }).then(function (response) {
